...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_github_installations_account_login"),
        "github_installations",
        ["account_login"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("ACTIVE", "PAUSED", "ARCHIVED", name="projectstatus"), nullable=False
        ),
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "source",
            sa.Enum("GITHUB_ISSUE", "GITHUB_PR", "API", "SCHEDULED", "WEBHOOK", name="tasksource"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("QUEUED", "RUNNING", "COMPLETED", "FAILED", "SKIPPED", name="runstatus"),
            nullable=False,
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_github_installations_installation_id"), table_name="github_installations"
    )
